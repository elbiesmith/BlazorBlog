...
namespace BlazorBlog.Shared.Data.Migrations
{
    /// <inheritdoc />
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PostTag (Dictionary<string, object>)_Tag_TagsId",
                        column: x => x.TagsId,
                        principalTable: "Tag",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PostTag (Dictionary<string, object>)_TagsId",
                table: "PostTag (Dictionary<string, object>)",
                column: "TagsId");
        }
